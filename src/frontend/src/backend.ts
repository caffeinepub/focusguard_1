...
import type { StudySession as _StudySession, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async completePomodoroCycle(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completePomodoroCycle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSessions(): Promise<Array<StudySession>> {
        if (this.processError) {
            try {
    ...
    async isPomodoroTimerActive(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isPomodoroTimerActive(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async pausePomodoroTimer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.pausePomodoroTimer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordSession(arg0: Principal, arg1: Time, arg2: Time | null, arg3: Time, arg4: Time, arg5: bigint, arg6: bigint, arg7: Time, arg8: boolean, arg9: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordSession(arg0, arg1, to_candid_opt_n12(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5, arg6, arg7, arg8, arg9);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startPomodoroTimer(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.startPomodoroTimer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async stopPomodoroTimer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.stopPomodoroTimer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_StudySession_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StudySession): StudySession {
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    distractionCount: bigint;
    distractions: bigint;
    pausedDuration: _Time;
    pomodoroCyclesCompleted: bigint;
    focusedDuration: _Time;
    distractionTime: _Time;
}): {
    startTime: Time;
    endTime?: Time;
    isPomodoro: boolean;
    ...
    return {
        ...
        focusedDuration: value.focusedDuration,
        distractionTime: value.distractionTime
    };
}
...
function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StudySession>): Array<StudySession> {
    return value.map((x)=>from_candid_StudySession_n9(_uploadFile, _downloadFile, x));
}
